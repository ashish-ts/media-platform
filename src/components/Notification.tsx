                ...
                <>
                    {notificationData.length > 0 ? (
                        notificationData.map((notify: any, index) => (
                            <div key={index}>
                                {notify.senderUser.map((senderuser: IUserProps, i: number) => {

                                    return (
                                        <div key={i} className='w-full h-[85px] max-h-[110px]  flex-wrap flex gap-1 dark:bg-black bg-white border-b-black border-b-[1px] dark:border-b-neutral-700  justify-start items-center '>
