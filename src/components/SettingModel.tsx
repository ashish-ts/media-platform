...
const SettingModel = () => {
    ...
    return (
        <div className={`  ${appearance ? 'h-auto w-[250px]' : 'h-[300px] w-auto'}
        ...
        `}>
            <div className={`${appearance ? 'hidden' : 'flex'} w-full h-11 flex justify-center items-center border-b-[1px] border-b-neutral-500 mb-4`}>
                <h1>Settings</h1>
            </div>
            {appearance && (
                <div
            ...
            <button
                ...
                className={`dark:hover:bg-black hover:bg-gray-200 w-full flex justify-start items-center px-4 py-2  rounded-lg border-none outline-none ${appearance ? 'hidden' : 'flex'}`}
            >
                {isLogout ? 'Logging Out...' : 'Log out'}
            </button>
            <button className={` ${appearance ? 'hidden' : 'flex'} dark:hover:bg-black hover:bg-gray-200 w-full  flex justify-between  gap-4 items-end px-4 py-2 rounded-lg border-none outline-none`}
            ...
            <button className={` ${appearance ? 'hidden' : 'flex'} dark:hover:bg-black hover:bg-gray-200 w-full  flex justify-start items-center  gap-2 px-4 py-2 rounded-lg border-none outline-none`}
